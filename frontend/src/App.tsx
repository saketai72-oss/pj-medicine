...
export default function App() {
  ...
  const handleToggleDemoMode = () => {
    ...
    toast.success(
      `Đã chuyển sang chế độ ${nextMode ? "Demo Mock" : "Kết nối API Thật"}`,
    );
  };
    ...
    try {
      ...
      toast.error(
        err instanceof Error
          ? err.message
          : "Đã xảy ra lỗi khi kết nối dịch vụ API!",
      );
    } finally {
      setIsLoading(false);
    }
  ...
  if (view === "404") {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center">
        ...
        <h1 className="text-4xl font-extrabold font-heading text-text mb-4">
          404 - Không tìm thấy trang
        </h1>
        <p className="text-text/75 mb-8 max-w-md">
          Trang bạn đang truy cập không tồn tại hoặc đã được di chuyển sang một
          địa chỉ khác.
        </p>
        <button
  ...
  if (view === "error") {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-text/75 mb-8 max-w-md">
          Hệ thống hỗ trợ quyết định lâm sàng (CDSS) gặp lỗi kết nối server hoặc
          lỗi tải mô hình XLM-RoBERTa.
        </p>
  ...
  if (view === "landing") {
    return (
      <div className="min-h-screen bg-white">
        ...
        <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
          <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm font-medium">
              ...
              <button className="px-5 py-2 border border-primary text-primary rounded-full font-semibold hover:bg-primary hover:text-white transition-all">
                Đăng nhập
              </button>

              <button className="px-5 py-2 bg-gradient-to-r from-primary to-cyan-500 text-white rounded-full font-semibold shadow-lg hover:scale-105 transition-all">
                Đăng ký
              </button>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden border-b border-gray-100 bg-white/95 backdrop-blur-md px-6 py-4 flex flex-col gap-4">
              ...
              <button className="w-full py-2 border border-primary text-primary rounded-xl font-semibold">
                Đăng nhập
              </button>

              <button className="w-full py-2 bg-primary text-white rounded-xl font-semibold">
                Đăng ký
              </button>
        ...
        {/* Hero Section */}
        <main
          className="max-w-6xl mx-auto px-6 py-24 flex flex-col items-center text-center"
          id="overview"
        >
          ...
          <p className="text-xl text-text/75 mb-12 max-w-2xl leading-relaxed">
            Hệ thống hỗ trợ quyết định lâm sàng thế hệ mới. Áp dụng kiến trúc
            Dynamic Expert Switching với XLM-RoBERTa đa ngữ giúp phân loại bệnh
            án tiếng Việt chính xác, độ trễ tính bằng mili-giây, tích hợp bản đồ
            nhiệt giải thích XAI.
          </p>
        ...
        <section
          id="architecture"
          className="bg-gray-50/50 py-24 border-y border-gray-100"
        >
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex flex-col items-center text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold font-heading text-text mb-4">
                Kiến trúc Dynamic Expert Switching
              </h2>
              <p className="text-text/75 max-w-2xl text-lg">
                Tận dụng sức mạnh đa ngữ của XLM-RoBERTa và tính chuyên biệt của
                nhiều LoRA Adapters khác nhau cho từng chuyên khoa.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
                <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col items-center text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-sm text-text/75">
                    Sử dụng định tuyến chuyên khoa (Hô hấp, Tim mạch...) siêu
                    tốc.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border-2 border-primary/20 shadow-lg shadow-primary/5 flex flex-col items-center text-center transform lg:-translate-y-4 hover:shadow-xl hover:scale-102 transition-all duration-300">
                  ...
                  <h3 className="font-bold text-lg mb-2 text-primary">
                    2. Multi-LoRA Loading
                  </h3>
                  <p className="text-sm text-text/75">
                    Nạp động (Dynamic Loading) Adapter .safetensors tương ứng
                    vào XLM-RoBERTa Base Model đang chạy trên RAM.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm flex flex-col items-center text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-sm text-text/75">
                    XLM-RoBERTa + LoRA thực hiện dự đoán phân loại đa nhãn với
                    cơ chế attention đa ngữ, hỗ trợ tiếng Việt tự nhiên với độ
                    trễ tối thiểu.
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border-2 border-cta/20 shadow-lg shadow-cta/5 flex flex-col items-center text-center transform lg:-translate-y-4 hover:shadow-xl hover:scale-102 transition-all duration-300">
                  ...
                  <h3 className="font-bold text-lg mb-2 text-cta">
                    4. XAI Explainability
                  </h3>
                  <p className="text-sm text-text/75">
                    Module giải thích phân tích hotspots đảm bảo tính minh bạch
                    y khoa.
                  </p>
                </div>
              </div>
        ...
        <section id="techstack" className="py-24 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex flex-col items-center text-center mb-16">
              ...
              <p className="text-text/75 max-w-2xl text-lg">
                Thiết kế tối ưu hiệu năng và khả năng mở rộng.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="p-8 rounded-3xl bg-gray-50 border border-gray-100 hover:border-primary/30 transition duration-300">
                ...
                <ul className="space-y-3 text-text/75">
                  <li className="flex items-center gap-2">
                    ...
                    XLM-RoBERTa (Multilingual) + LoRA
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> Hugging
                    Face PEFT (LoRA)
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> PyTorch
                    Framework
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> LIME/SHAP
                    explainability
                  </li>
                </ul>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-gray-50 border border-gray-100 hover:border-primary/30 transition duration-300">
                ...
                <ul className="space-y-3 text-text/75">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> FastAPI
                    (Async Python)
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> PostgreSQL
                    & SQLAlchemy
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> Redis
                    Caching
                  </li>
                </ul>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-gray-50 border border-gray-100 hover:border-primary/30 transition duration-300">
                ...
                <ul className="space-y-3 text-text/75">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> React.js +
                    TypeScript
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> Recharts
                    (Data Viz)
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-primary" /> Tailwind
                    CSS v3
                  </li>
                </ul>
              </div>
            ...
            <div className="grid md:grid-cols-4 gap-10 mb-12">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-xl font-bold">Drug-Pred AI</span>
                </div>

                <p className="text-white/60 text-sm leading-relaxed">
                  Hệ thống hỗ trợ quyết định lâm sàng ứng dụng XLM-RoBERTa +
                  Multi-LoRA giúp dự đoán nhóm thuốc từ mô tả bệnh án tiếng
                  Việt.
                </p>
              </div>
      ...
      <aside className="w-full md:w-80 bg-white border-r border-gray-200 flex flex-col md:h-screen sticky top-0 shadow-lg shadow-gray-200/20 z-20">
        ...
        {subView === "predict" && (
          <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-6 hidden md:flex">
            <div>
              <h3 className="text-xs font-bold text-text/75 uppercase tracking-wider mb-3">
                1. Routing Chuyên khoa
              </h3>
                ...
                {activeSpecialty.cases.map(
                  (c: { title: string; text: string }, i: number) => (
                    ...
                    >
                      ...
                      <p className="text-[11px] text-text/70 line-clamp-3 leading-relaxed">
                        {c.text}
                      </p>
                    </div>
                  ),
        ...
        <div className="w-full max-w-4xl flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
              ...
              {!selectedPatient && (
                <div className="p-4 bg-amber-50/50 rounded-2xl border border-amber-100 text-xs text-amber-800 flex items-start gap-2.5">
                  ...
                  <div>
                    <strong>Mẹo y khoa:</strong> Bạn chưa chọn bệnh nhân nào.
                    Hãy sang tab{" "}
                    <button
                      onClick={() => setSubView("patients")}
                    ...
                    để chọn bệnh nhân hoặc tạo bệnh án lâm sàng trực tiếp để lưu
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          inputMode === "edit"
                            ...
                            : "bg-white hover:bg-gray-50 text-text/75",
                        )}
                      >
                        Sửa bệnh án
                      </button>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-text/50 mt-0.5">
                          Top 3 nhóm thuốc có xác suất phù hợp cao nhất
                        </p>
                      </div>
                    </div>
                  ...
                  {xaiTokens.length > 0 && (
                    <div className="mt-4 p-4 bg-slate-900 rounded-2xl text-slate-100 text-xs flex flex-col gap-2 border border-slate-800">
                      ...
                      <p className="text-slate-300 leading-relaxed">
                        Bạn có thể chuyển chế độ hiển thị{" "}
                        <strong>Hotspots XAI</strong> trong khung nhập liệu ở
                        trên để tô màu các từ có trọng số quyết định cao trong
                        chẩn đoán.
                      </p>
                    </div>
                  )}
                  ...
                  <div className="mt-4 p-4 bg-blue-50/50 rounded-2xl border border-blue-100 flex items-start gap-3">
                    ...
                    <p className="text-xs text-text/70 leading-relaxed">
                      <strong className="block text-text font-bold mb-0.5">
                        Khước từ trách nhiệm lâm sàng:
                      </strong>
                      Kết quả từ hệ thống hỗ trợ quyết định (CDSS) này chỉ đóng
                      vai trò tham khảo trong nghiên cứu khoa học. Người hành
                      nghề y phải tự kiểm chứng và chịu hoàn toàn trách nhiệm
                      đối với quyết định điều trị lâm sàng.
                    </p>
                  </div>
                </div>
              )}
          ...
          {subView === "patients" && (
            <React.Suspense fallback={<ShimmerSkeleton />}>
              <PatientSection
                onSelectPatientForPrediction={selectPatientForPrediction}
              />
            </React.Suspense>
          )}
